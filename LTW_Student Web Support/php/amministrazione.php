<?php
    ...
    // Salviamo il nome dell'utente che si è loggato
...
<body>
    ...
    <section id="gestore">
        ...
        <div class="container justify-content-center pb-5">
            <div class="col-12  fade-in text-center">
                ...
                <!-- Qui viene mostrato il nome dell'amministratore che si è loggato -->
        ...
        <!-- Counter che mostra quanti dati sono presenti nelle varie tabelle del DB -->
        ...
        <!-- Sezione in cui sono disponibili le azioni che può fare un'amministratore -->
        <div class="container justify-content-center py-5">
            <div class="col-12  fade-in text-center">
                ...
                <div class="row col-12 justify-content-center">
                    <a class="btn btn-brand col-4 p-3 m-3" onclick="return caricaAzione('insert-evento')">Inserisci un evento</a>
                    <a class="btn btn-brand col-4 p-3 m-3" onclick="return caricaEliminazione('delete-evento')">Elimina un evento</a>

                    <a class="btn btn-brand col-4 p-3 m-3" onclick="return caricaAzione('insert-faq')">Inserisci una Faq</a>
                    <a class="btn btn-brand col-4 p-3 m-3" onclick="return caricaEliminazione('delete-faq')">Elimina una Faq</a>
    ...
    <section id="zonaDinamica">
        ...
        <!-- Per caricare la risposta di Ajax in base all'azione che l'amministratore vuole svolgere -->
